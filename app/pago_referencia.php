...
function responder_pago($codigo, $mensaje, $autorizacion = '', $transaccion = '') {
    echo json_encode([
        ...
        'notificacion_sms'  => '',
        'mensaje_sms'       => '',
        'mensaje_ticket'    => 'Gracias por tu pago. EduPago actualizará tu saldo automáticamente.',
...
try {
    ...
    $pdo->prepare("UPDATE cobros SET estado = 'pagado', auth_code = ?, ref_transaccion = ? WHERE id = ?")
