...
define('PLE_INT_ID',   'xxx');      // <-- Reemplazar con el IntegrationID de Pagalaescuela del correo

define('PLE_SCHOOL_ID','xxx');   // <-- Reemplazar con el SchoolID de Pagalaescuela del correo
