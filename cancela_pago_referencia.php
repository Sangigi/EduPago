 ...
 *
 * Cobroscontarjeta.com llama: POST o DELETE https://TU_DOMINIO/cancela_pago_referencia.php
...
function log_ref_cancela($msg) {
    if (defined('REFERENCIA_LOG_FILE')) {
        file_put_contents(REFERENCIA_LOG_FILE, date('Y-m-d H:i:s') . ' | CANCELA | ' . $msg . "\n", FILE_APPEND);
    }
}
