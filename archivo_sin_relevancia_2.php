            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="Documentos/plantilla_productos.csv" class="btn btn-sm btn-outline-success d-block" download="plantilla_productos.xlsx">
...
setTimeout(inicializarTooltips, 100);
            ...
            function eliminarProducto(id, nombre) {
                ...
                if (!confirm(`⚠️ ¿Estás SEGURO de que deseas eliminar el producto "${nombre}"?\n\nEsto verificará si tiene dependencias (ventas, compras, movimientos).`)) {
                    return;
                }
...
function calcularUtilidadDesdePrecio() {
    ...
    switch (unidad) {
        ...
        case 'kilogramo':
            step = 0.001;
            mensaje = '⚖️ <strong>Kilos:</strong> Stock en kilogramos (puede usar decimales, ej: 1.5 kg)';
        ...
        case 'ton':
            step = 0.001;
            mensaje = '🏗️ <strong>Toneladas:</strong> Stock en toneladas (puede usar decimales)';
