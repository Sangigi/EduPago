...
$vals = [
    ...
    'rep_legal_escritura_numero' => $campo('rep_legal_escritura_numero', 60),
    'rep_legal_escritura_fecha'  => $campoFecha('rep_legal_escritura_fecha'),
    ...
    'empresa_escritura_numero' => $campo('empresa_escritura_numero', 60),
    'empresa_escritura_fecha'  => $campoFecha('empresa_escritura_fecha'),
